...
#if defined (V54_BSP)
#define MMD7_1000_LED_CTRL	0x8076
#endif
...
#if defined (V54_BSP)
	malibu_phy_reg_write(0,0x4,0xd,0x7);
	malibu_phy_reg_write(0,0x4,0xe,MMD7_1000_LED_CTRL);
	malibu_phy_reg_write(0,0x4,0xd,0x4007);
	malibu_phy_reg_write(0,0x4,0xe,0x650);
#endif
	malibu_phy_reg_write(dev_id, phy_id, MALIBU_PHY_CONTROL, phy_data);
	return SW_OK;
